...
var formatters = {
  ...
  R: function R(date, token, _localize, options) {
    var isoWeekYear = (0, _index8.default)(date, options)
  ...
  I: function I(date, token, localize, options) {
    var isoWeek = (0, _index6.default)(date, options)
  ...
  D: function D(date, token, localize, options) {
    var dayOfYear = (0, _index4.default)(date, options)
